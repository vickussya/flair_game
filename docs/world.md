FLAIR — WORLD
Source-material fidelity, the world bible, and the map of the block Level 1 is set on.

Index: [concept.md](concept.md) | Characters + case: [case.md](case.md) | Systems: [systems.md](systems.md) | Production: [production.md](production.md)
